...
public class EmployeeController {
	...
	@ResponseStatus
	public  ResponseEntity<EmployeeResponse> getEmployeeDetailsByEmployeeId(@PathVariable(name = "employeeId")String employeeId) {
			
		return new ResponseEntity<EmployeeResponse>(employeeService.getEmployeeDetails(employeeId), HttpStatus.ACCEPTED);
	}
